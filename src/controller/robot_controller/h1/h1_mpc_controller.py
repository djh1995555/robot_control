...
class H1MPCContoller(RobotNumerialContoller):
    ...
    def init_components(self, model, data, state):
        ...
        self.kinDynSolver = Pin_KinDyn("/home/djh/robot/robot_control/resources/robot/h1/urdf/h1.urdf")
        ...
        self.pvtCtr = PVT_Ctr(self.dt, "/home/djh/robot/robot_control/config/h1/joint_ctrl_config.json")
