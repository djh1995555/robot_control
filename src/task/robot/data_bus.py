...
class DataBus:
    ...
    @staticmethod
    def printdq(q: np.ndarray):
        """Print dq vector in formatted blocks"""
        print(np.array2string(q[:6], precision=5))
        print(np.array2string(q[6:13], precision=5))
        print(np.array2string(q[13:20], precision=5))
        print(np.array2string(q[20:24], precision=5))
        print(np.array2string(q[24:30], precision=5))
        print(np.array2string(q[30:36], precision=5))
    
    @staticmethod
    def printq(q: np.ndarray):
        """Print q vector in formatted blocks"""
        print(np.array2string(q[:7], precision=5))
        print(np.array2string(q[7:14], precision=5))
        print(np.array2string(q[14:21], precision=5))
        print(np.array2string(q[21:25], precision=5))
        print(np.array2string(q[25:31], precision=5))
        print(np.array2string(q[31:37], precision=5))
